...
-- Lookup Tables
DROP TABLE IF EXISTS `vehicle_status_type`;
...
DROP TABLE IF EXISTS `vehicle_condition_type`;
...
DROP TABLE IF EXISTS `workflow_step_type`;
...
DROP TABLE IF EXISTS `vehicle_metadata`;
...
DROP TABLE IF EXISTS `auction_filter`;
